...
fn bundle_chain_zsa() {
    ...
    assert_eq!(
        ...
        [
            76, 185, 199, 190, 227, 21, 32, 86, 159, 70, 70, 90, 76, 61, 205, 47, 159, 70, 26, 14,
            91, 119, 128, 6, 35, 71, 130, 5, 218, 197, 176, 172
        ]
    );
    assert_eq!(
        orchard_digest_2,
        // Locks the `orchard_digest` for OrchardZSA
        [
            247, 25, 195, 133, 62, 71, 27, 40, 53, 55, 13, 135, 140, 96, 167, 26, 202, 126, 71, 84,
            108, 249, 212, 9, 58, 54, 218, 187, 107, 52, 113, 68
        ]
    );
}
