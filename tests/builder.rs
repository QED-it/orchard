...
fn bundle_chain_zsa() {
    ...
    assert_eq!(
        ...
        [
            48, 91, 45, 127, 255, 177, 14, 11, 125, 36, 246, 87, 28, 198, 121, 45, 36, 11, 186, 90,
            32, 125, 233, 25, 91, 124, 197, 147, 160, 81, 21, 144
        ]
    );
    assert_eq!(
        orchard_digest_2,
        // Locks the `orchard_digest` for OrchardZSA
        [
            204, 103, 13, 75, 121, 25, 208, 82, 186, 204, 172, 127, 141, 43, 143, 96, 202, 52, 129,
            237, 77, 41, 29, 250, 110, 112, 252, 170, 71, 106, 188, 148
        ]
    );
}
