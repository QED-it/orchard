...
fn bundle_chain_zsa() {
    ...
    assert_eq!(
        ...
        [
            196, 8, 92, 88, 63, 78, 68, 2, 11, 224, 246, 152, 123, 26, 117, 194, 85, 70, 158, 123,
            173, 158, 105, 31, 84, 157, 34, 249, 239, 160, 162, 234
        ]
    );
    assert_eq!(
        orchard_digest_2,
        // Locks the `orchard_digest` for OrchardZSA
        [
            229, 73, 156, 35, 36, 63, 250, 80, 255, 32, 230, 25, 100, 229, 223, 95, 15, 10, 216,
            223, 171, 39, 42, 50, 58, 135, 87, 176, 200, 113, 255, 3
        ]
    );
}
