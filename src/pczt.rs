...
mod tests {
    ...
    fn shielded_bundle_orchard_zsa() {
        ...
        assert_eq!(
            ...
            // Locks the `orchard_digest` for OrchardZSA
            &[
                20, 51, 208, 163, 44, 100, 246, 67, 220, 145, 188, 120, 84, 202, 73, 16, 202, 134,
                186, 162, 14, 222, 215, 160, 26, 33, 108, 69, 112, 129, 187, 233
            ],
        );
        ...
        assert_eq!(
            ...
            // Locks the `orchard_digest` for OrchardZSA
            &[
                197, 19, 253, 90, 128, 90, 210, 6, 193, 137, 81, 63, 114, 231, 183, 14, 120, 191,
                18, 149, 75, 87, 86, 238, 199, 143, 162, 25, 255, 252, 54, 95
            ],
        );
    }
    ...
    fn shielded_bundle_orchard_vanilla() {
        ...
        assert_eq!(
            ...
            // This ensures backward compatibility.
            &[
                191, 103, 16, 132, 199, 118, 182, 44, 252, 170, 215, 112, 18, 223, 186, 190, 233,
                210, 53, 20, 209, 17, 17, 40, 142, 67, 197, 208, 181, 99, 8, 24
            ],
        );
    }
}
