...
pub enum OrchardSighashKind {
    ...
    /// [sighashversioning]: https://zips.z.cash/zip-0246#sighash-versioning
    AllEffecting,
    /// This is the "V1" sighash that only commits to the action group being signed, as defined in
    /// [ZIP-228: Asset Swaps for ZSAs][zip228]
    ///
    /// [zip228]: https://zips.z.cash/zip-0228#v1-signature-digest
    OnlyActionGroup, //TODO: need to implement this sighash version properly
}
...
pub(crate) fn test_sighash_info_for_kind(kind: &OrchardSighashKind) -> Vec<u8> {
    match kind {
        ...
        OrchardSighashKind::OnlyActionGroup => vec![1], //TODO: need to implement this sighash version properly
    }
}
