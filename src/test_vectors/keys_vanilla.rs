//! Test vectors for vanilla (non-ZSA) Orchard key components, including the
//! quantum-recoverable (ZIP 2005) `note_qr_rcm`/`note_qr_cmx` fields.
//!
//! The ZSA variants of these vectors (with issuance keys and asset fields, but
//! without the QR fields) live in [`super::keys`].
