...
// FIXME: rename to vanilla.rs (as it's alredy in circuit folder)?
...
mod tests {
    ...
    type Circuit = GenericCircuit<OrchardDomainVanilla>;
    ...
    fn round_trip() {
        ...
        let pk = ProvingKey::build::<OrchardDomainVanilla>();
